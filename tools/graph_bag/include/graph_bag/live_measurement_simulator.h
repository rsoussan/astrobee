...
#ifndef GRAPH_BAG_LIVE_MEASUREMENT_SIMULATOR_H_
...
class LiveMeasurementSimulator {
 public:
  ...
  boost::optional<ff_msgs::FamCommand> GetFamCommandMessage(const localization_common::Time current_time);
 ...
 private:
  ...
  MessageBuffer<ff_msgs::FamCommand> fam_command_buffer_;
...
#endif  // GRAPH_BAG_LIVE_MEASUREMENT_SIMULATOR_H_

...
#ifndef SLIDING_WINDOW_GRAPH_OPTIMIZER_CUMULATIVE_FACTOR_ADDER_H_
#define SLIDING_WINDOW_GRAPH_OPTIMIZER_CUMULATIVE_FACTOR_ADDER_H_
...
#endif  // SLIDING_WINDOW_GRAPH_OPTIMIZER_CUMULATIVE_FACTOR_ADDER_H_

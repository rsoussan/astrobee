 ...
 * under the License.
 */
#ifndef SLIDING_WINDOW_GRAPH_OPTIMIZER_GRAPH_STATS_H_
#define SLIDING_WINDOW_GRAPH_OPTIMIZER_GRAPH_STATS_H_
...
#endif  // SLIDING_WINDOW_GRAPH_OPTIMIZER_GRAPH_STATS_H_

 ...
 * under the License.
 */
#ifndef SLIDING_WINDOW_GRAPH_OPTIMIZER_PARAMETER_READER_H_
#define SLIDING_WINDOW_GRAPH_OPTIMIZER_PARAMETER_READER_H_
...
#endif  // SLIDING_WINDOW_GRAPH_OPTIMIZER_PARAMETER_READER_H_

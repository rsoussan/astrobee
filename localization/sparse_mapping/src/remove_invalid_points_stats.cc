...
#include <sparse_mapping/remove_invalid_points_stats.h>

#include <glog>

namespace sparse_mapping {
    RemoveInvalidPointsStats::RemoveInvalidPointsStats():total(0), small_angle(0), behind_cam(0), invalid_reproj(0),
                  big_reproj_err(0), num_features(0) {}
    RemoveInvalidPointsStats::Print() {

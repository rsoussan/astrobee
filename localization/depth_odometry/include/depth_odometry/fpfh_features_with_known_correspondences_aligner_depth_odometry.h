 ...
 * under the License.
 */
#ifndef DEPTH_ODOMETRY_FPFH_FEATURES_WITH_KNOWN_CORRESPONDENCES_ALIGNER_DEPTH_ODOMETRY_H_
#define DEPTH_ODOMETRY_FPFH_FEATURES_WITH_KNOWN_CORRESPONDENCES_ALIGNER_DEPTH_ODOMETRY_H_
...
class FPFHFeaturesWithKnownCorrespondencesAlignerDepthOdometry : public DepthOdometry {
 public:
  explicit FPFHFeaturesWithKnownCorrespondencesAlignerDepthOdometry(
  ...
  const FPFHFeaturesWithKnownCorrespondencesAlignerDepthOdometryParams& params() const { return params_; }

 private:
  FPFHFeaturesWithKnownCorrespondencesAlignerDepthOdometryParams params_;
  ...
  pcl::PointCloud<pcl::FPFHSignature33>::Ptr previous_fpfh_features_;
  pcl::PointCloud<pcl::FPFHSignature33>::Ptr latest_fpfh_features_;
  localization_common::Time previous_timestamp_;
  localization_common::Time latest_timestamp_;
};
}  // namespace depth_odometry

#endif  // DEPTH_ODOMETRY_FPFH_FEATURES_WITH_KNOWN_CORRESPONDENCES_ALIGNER_DEPTH_ODOMETRY_H_

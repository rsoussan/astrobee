...
SlidingWindowImuFilter::SlidingWindowImuFilter(const int length)
    : acceleration_x_filter_(length),
      acceleration_y_filter_(length),
      acceleration_z_filter_(length),
      angular_velocity_x_filter_(length),
      angular_velocity_y_filter_(length),
      angular_velocity_z_filter_(length) {}

lm::ImuMeasurement SlidingWindowImuFilter::AddMeasurement(const lm::ImuMeasurement& imu_measurement) {
